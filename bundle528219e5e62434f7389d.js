...
var point = Math.floor(Math.random() * _utils_constants__WEBPACK_IMPORTED_MODULE_4__.squareCount);
var direction = 1;
...
var generatePoint = function generatePoint() {
  ...
  (0,_utils_toggler__WEBPACK_IMPORTED_MODULE_2__.togglePoint)(_matrix__WEBPACK_IMPORTED_MODULE_1__.grid[point], false);
  point = newPoint;
  (0,_utils_toggler__WEBPACK_IMPORTED_MODULE_2__.togglePoint)(_matrix__WEBPACK_IMPORTED_MODULE_1__.grid[point], true);
};

var toggleHead = function toggleHead(isCreate) {
  return (0,_utils_toggler__WEBPACK_IMPORTED_MODULE_2__.toggleClass)((0,_utils_snake_head__WEBPACK_IMPORTED_MODULE_5__.takeHead)(), isCreate, [_utils_constants__WEBPACK_IMPORTED_MODULE_4__.transformCodes[activeKeyCode], 'head']);
};

var eatPoint = function eatPoint() {
  _matrix__WEBPACK_IMPORTED_MODULE_1__.snake.push((0,_utils_snake_head__WEBPACK_IMPORTED_MODULE_5__.takeHeadIndex)() + direction);
  generatePoint();
};

var move = function move(keyCode) {
  if (activeMode === 'hard' && (direction === 1 && ((0,_utils_snake_head__WEBPACK_IMPORTED_MODULE_5__.takeHeadIndex)() + direction) % _utils_constants__WEBPACK_IMPORTED_MODULE_4__.switchNumber === 0 || direction === -1 && (0,_utils_snake_head__WEBPACK_IMPORTED_MODULE_5__.takeHeadIndex)() % _utils_constants__WEBPACK_IMPORTED_MODULE_4__.switchNumber === 0) || _matrix__WEBPACK_IMPORTED_MODULE_1__.snake.filter(function (v, i, arr) {
    return arr.indexOf(v) !== i;
  }).length || (0,_utils_snake_head__WEBPACK_IMPORTED_MODULE_5__.takeHeadIndex)() < 0) {
    endGame();
  } else {
    activeKeyCode = keyCode;
    var tmp = _matrix__WEBPACK_IMPORTED_MODULE_1__.snake.pop();
    (0,_utils_toggler__WEBPACK_IMPORTED_MODULE_2__.toggleClass)(_matrix__WEBPACK_IMPORTED_MODULE_1__.grid[tmp], false);
    toggleHead(false);
    _matrix__WEBPACK_IMPORTED_MODULE_1__.snake.unshift((0,_utils_snake_head__WEBPACK_IMPORTED_MODULE_5__.takeHeadIndex)() + direction);

    if ((0,_utils_snake_head__WEBPACK_IMPORTED_MODULE_5__.takeHead)()) {
      if (point === (0,_utils_snake_head__WEBPACK_IMPORTED_MODULE_5__.takeHeadIndex)()) {
        eatPoint();
      }

      toggleHead(true);
      (0,_utils_toggler__WEBPACK_IMPORTED_MODULE_2__.toggleClass)((0,_utils_snake_head__WEBPACK_IMPORTED_MODULE_5__.takeHead)(), true);
    } else {
      endGame();
    }
  }
...
_utils_modes__WEBPACK_IMPORTED_MODULE_3__.mode$.subscribe(function (mode) {
  activeMode = mode;

  if (activeMode === 'hard') {
    (0,_utils_toggler__WEBPACK_IMPORTED_MODULE_2__.toggleClass)(_matrix__WEBPACK_IMPORTED_MODULE_1__.matrix, false, 'classic');
    (0,_utils_toggler__WEBPACK_IMPORTED_MODULE_2__.toggleClass)(_matrix__WEBPACK_IMPORTED_MODULE_1__.matrix, true, 'hard');
  } else {
    (0,_utils_toggler__WEBPACK_IMPORTED_MODULE_2__.toggleClass)(_matrix__WEBPACK_IMPORTED_MODULE_1__.matrix, false, 'hard');
    (0,_utils_toggler__WEBPACK_IMPORTED_MODULE_2__.toggleClass)(_matrix__WEBPACK_IMPORTED_MODULE_1__.matrix, true, 'classic');
  }
});

var endGame = function endGame() {
  if ((0,_utils_snake_head__WEBPACK_IMPORTED_MODULE_5__.takeHead)()) {
    (0,_utils_toggler__WEBPACK_IMPORTED_MODULE_2__.toggleClass)((0,_utils_snake_head__WEBPACK_IMPORTED_MODULE_5__.takeHead)(), false, 'head');
    (0,_utils_toggler__WEBPACK_IMPORTED_MODULE_2__.toggleClass)((0,_utils_snake_head__WEBPACK_IMPORTED_MODULE_5__.takeHead)(), false, _utils_constants__WEBPACK_IMPORTED_MODULE_4__.transformCodes[activeKeyCode]);
  }

  for (var i = 0; i < _matrix__WEBPACK_IMPORTED_MODULE_1__.snake.length; i++) {
    var removedSnake = _matrix__WEBPACK_IMPORTED_MODULE_1__.grid[_matrix__WEBPACK_IMPORTED_MODULE_1__.snake[i]];

    if (removedSnake) {
      (0,_utils_toggler__WEBPACK_IMPORTED_MODULE_2__.toggleClass)(removedSnake, false);
    }
  }

  reset();
  _utils_alert__WEBPACK_IMPORTED_MODULE_0__.alert.show();
};
...
var reset = function reset() {
  ...
  direction = 1;
  activeKeyCode = 39;
  (0,_matrix__WEBPACK_IMPORTED_MODULE_1__.createSquares)();
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "createSquares": () => (/* binding */ createSquares),
/* harmony export */   "grid": () => (/* binding */ grid),
/* harmony export */   "matrix": () => (/* binding */ matrix),
/* harmony export */   "snake": () => (/* binding */ snake)
/* harmony export */ });
/* harmony import */ var _utils_toggler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/toggler */ "./src/app/utils/toggler.js");
/* harmony import */ var _utils_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/constants */ "./src/app/utils/constants.js");



var currentSnake = function currentSnake() {
  return Array(8).fill(0).map(function (v, i) {
    return i;
  }).reverse();
};
...
var snake = currentSnake();
var createSquares = function createSquares() {
  grid = document.querySelectorAll('#matrix div');
  snake = currentSnake();

  for (var i = 0; i < 8; i++) {
    (0,_utils_toggler__WEBPACK_IMPORTED_MODULE_0__.toggleClass)(grid[i], true);
  }

  (0,_utils_toggler__WEBPACK_IMPORTED_MODULE_0__.toggleClass)(grid[snake[0]], true, ['right', 'head']);
};

for (var i = 0; i < _utils_constants__WEBPACK_IMPORTED_MODULE_1__.squareCount; i++) {
...
var mode$ = new rxjs__WEBPACK_IMPORTED_MODULE_0__.Subject();
var form = document.querySelector('form[name="modeSwitcher"]');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "takeHead": () => (/* binding */ takeHead),
/* harmony export */   "takeHeadIndex": () => (/* binding */ takeHeadIndex)
/* harmony export */ });
/* harmony import */ var _matrix__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../matrix */ "./src/app/matrix.js");

var takeHeadIndex = function takeHeadIndex() {
  return _matrix__WEBPACK_IMPORTED_MODULE_0__.snake[0];
};
var takeHead = function takeHead() {
  return _matrix__WEBPACK_IMPORTED_MODULE_0__.grid[takeHeadIndex()];
};

/***/ }),

/***/ "./src/app/utils/toggler.js":
/*!**********************************!*\
  !*** ./src/app/utils/toggler.js ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "togglePoint": () => (/* binding */ togglePoint)
/* harmony export */ });
var toggle = function toggle(el, isActive, className) {
  if (isActive) {
...
var toggleClass = function toggleClass(el, isActive) {
  var className = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'snake';
...
var togglePoint = function togglePoint(el, isCreate) {
  var points = ['apple', 'banana', 'orange', 'grape', 'kiwi'];

  if (isCreate) {
    el.classList.add(points[Math.floor(Math.random() * points.length)]);
  } else {
    var fruit = points.find(function (f) {
      return f === el.classList.value;
    });
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_assets_styles_global_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! -!../node_modules/css-loader/dist/cjs.js!./assets/styles/global.scss */ "./node_modules/css-loader/dist/cjs.js!./src/assets/styles/global.scss");
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/images/eye.svg */ "./src/assets/images/eye.svg"), __webpack_require__.b);
...
/***/ "./node_modules/css-loader/dist/cjs.js!./src/assets/styles/global.scss":
/*!*****************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./src/assets/styles/global.scss ***!
  \*****************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
